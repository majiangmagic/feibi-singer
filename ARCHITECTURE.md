...
- `ARCHITECTURE.md`：项目整体架构、目录职责和设计约束；
- `PROGRESS.md`：当前验证状态、已完成工作、进行中事项和下一步；
- `FEATURES.md`：按优先级维护的单功能项清单及验证证据；
- `DECISIONS.md`：重要技术决策、原因、替代方案和影响；
- `harness/harness_context.py`：Harness JSON 与 Markdown 双向转换及索引查询工具；
- `harness/ARCHITECTURE.md`：Harness 子模块的结构、用法和约束；
