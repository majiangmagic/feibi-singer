...
- 测试状态：项目独立 Python 3.11 venv 中 14 项 pytest 通过；真实 98.2 秒音频完成时间轴对齐、ACE-Step、RVC 和提高 2 dB 人声后的原始伴奏混音验证
- Lint：默认真实入口已自动检测原唱窗口并延迟歌声，RVC 人声混音默认增加 2 dB；旧整曲直通方案改为显式 legacy 选项
