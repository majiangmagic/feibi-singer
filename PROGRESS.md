...
### 当前状态
- 最新 commit: `working-tree`（update default ACE caption for clear Mandarin diction）
...
- [x] The default ACE caption now uses strict source-melody preservation and explicit clear Mandarin pronunciation guidance for ???????.

### 进行中
- [ ] Default ACE caption update is verified and ready to commit.
...
### 下一步
1. Commit the default ACE caption update.。
